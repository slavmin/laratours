...
class DetailedTourController extends Controller
{
    public function getDetailedTourObjects(Request $request)
    {
        ...
        switch ($request->model_alias) {
            ...
            case 'transport':
                $transport_options = TourTransport::with('objectables')
                    ->whereIn('city_id', $tour->cities_list)
                    ->get();
            ...
            case 'museum':
                $museum_options = TourMuseum::with('objectables')
                    ->whereIn('city_id', $tour->cities_list)
                    ->get();
                $tour_date = $tour->dates[0]->date;
                $days = $tour->duration;
            ...
            case 'hotel':
                $hotel_options = TourHotel::with('objectables')
                    ->whereIn('city_id', $tour->cities_list)
                    ->get();
                $tour_date = $tour->dates[0]->date;
                $nights = $tour->nights;
            ...
            case 'meal':
                $meal_options = TourMeal::with('objectables')
                    ->whereIn('city_id', $tour->cities_list)
                    ->get();
                $tour_date = $tour->dates[0]->date;
                $days = $tour->duration;
            ...
            case 'guide':
                $guide_options = TourGuide::whereIn('city_id', $tour->cities_list)->get();
                $tour_date = $tour->dates[0]->date;
                $days = $tour->duration;
            ...
            case 'attendant':
                $attendant_options = TourAttendant::whereIn('city_id', $tour->cities_list)->get();
                $tour_date = $tour->dates[0]->date;
                $days = $tour->duration;

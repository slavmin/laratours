...
export default {
  ...
  methods: {
    ...
    parseInfo() {
      ...
      this.qnt = this.room.qnt
      this.priceList = JSON.parse(this.room.extra).priceList
      this.additionalPrices = JSON.parse(this.room.extra).priceList.additionalPrices
      this.additionalCount = this.additionalPrices.length
    },
    close() {
      this.parseInfo()
      this.dialog = false

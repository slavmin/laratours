...
return [
    ...
    */
    'general' => [
        ...
        'cant_restore' => 'Восстановление не удалось или завершилось с ошибками',
        'canceled' => 'Действие отменено',
        'deleted_permanently' => 'Удалено навсегда',
        'deleted_not' => 'Удаление не удалось или завершилось с ошибками',
        'not_found' => 'Не найдено, удалено или не существует',

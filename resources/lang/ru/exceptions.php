    ...
    */
    ...
    'backend' => [
        'access' => [
            ...
            'teams' => [
                'cant_restore' => 'Эта компания не удалена, поэтому она не может быть восстановлена.',
                'create_error' => 'Невозможно создать компанию. Пожалуйста, попробуйте позже.',
                'delete_error' => 'Невозможно удалить компанию. Пожалуйста, попробуйте позже.',
                'delete_first' => 'Этота компания должена быть мягко удалена, прежде чем она может быть окончательно удалена.',
                'not_found' => 'Такой компании не существует.',
                'restore_error' => 'Невозможно восстановить компанию. Пожалуйста, попробуйте позже.',
                'user_needed' => 'Вы должны выбрать как минимум одного пользователя.',
                'update_error' => 'Невозможно обновить компанию. Пожалуйста, попробуйте позже.',
            ],
        ],
    ],
    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'confirm' => 'Подтвердите вашу почту!',
                'created_confirm' => 'Ваш учетная запись успешно создана. Мы отправили вам уведомление на ваш E-mail для подтверждения вашей почты.',
                'created_pending' => 'Ваша учетная запись создана и находится на рассмотрении. После удтверждения вашей учетной записи, вам будет отправлено уведомление на ваш E-mail.',
                'mismatch' => 'Неправильный код подтверждения.',
                'not_found' => 'Такого кода не существует.',
                'pending' => 'В настоящее время ваша учетная запись находится на рассмотрении. После удтверждения вашей учетной записи, вам будет отправлено уведомление на ваш E-mail.',
                'resend' => 'Ваша почта не подтверждена. Пожалуйста, нажмите на ссылку для подтверждения в письме высланном на Ваш E-mail, или <a href=":url">щелкните здесь</a>, чтобы повторно отправить подтверждение на Ваш E-mail.',
                'success' => 'Ваша почта успешно подтверждена!',
                'resent' => 'Новые параметры подтверждения высланы вам на ваш E-mail адрес.',
            ],

            'deactivated' => 'Ваша учетная запись не активирована.',
            ...
            'registration_error' => 'Невозможно завершить регистрацию. Пожалуйста, попробуйте позже.',
        ],
        'tours' => [
            'cant_restore' => 'Эта позиция не удалена, поэтому она не может быть восстановлена.',
            'create_error' => 'Невозможно создать позицию. Пожалуйста, попробуйте позже.',
            'delete_error' => 'Невозможно удалить позицию. Пожалуйста, попробуйте позже.',
            'delete_first' => 'Этота позиция должена быть мягко удалена, прежде чем она может быть окончательно удалена.',
            'not_found' => 'Такой позиции не существует.',
            'restore_error' => 'Невозможно восстановить позицию. Пожалуйста, попробуйте позже.',
            'update_error' => 'Невозможно обновить позицию. Пожалуйста, попробуйте позже.',
            'order_error' => 'Невозможно завершить бронирование. Пожалуйста, попробуйте позже.',
        ],
    ],
];

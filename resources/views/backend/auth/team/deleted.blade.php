...
@section('title', __('labels.backend.access.teams.management') . ' | ' . __('labels.backend.access.teams.deleted'))
            ...
            <div class="row">
                <div class="col-sm-5">
                    <h4 class="card-title mb-0">
                        ...
                        <small class="text-muted">@lang('labels.backend.access.teams.deleted')</small>
                    </h4>
                </div><!--col-->
            </div><!--row-->

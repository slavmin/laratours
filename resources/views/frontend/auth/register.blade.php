...
@endpush
@section('content')
<div class="pt-5 mb-5 row justify-content-center align-items-center">
          ...
          <div class="col-12 col-md-6">
            <div class="form-group md-form">
              ...
              {{ html()->text('inn')
                                    ...
                                    ->attribute('data-inputmask', "'mask': '999999999999'")
                                    ->value($params['inn'] ?? '')
                                    ->required() }}
            </div>
            <!--form-group-->
        ...
        <div class="row">
          ...
          <div class="col-12 col-md-6">
            <div class="form-group">
              ...
              <select name="profile[formal][company_type]" id="company_type" class="form-control" placeholder=""
                required>

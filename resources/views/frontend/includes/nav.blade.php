...
<v-toolbar id="tc-main-header" class="tc-main-header" tile>
    ...
    <ul id="tc-main-menu" class="tc-main-menu justify-end align-center d-none d-lg-flex">
        ...
        @auth
        <li>
            <v-btn text dark href="{{route('frontend.user.dashboard')}}"
        ...
        @guest
        <li>
            <v-btn text dark href="{{route('frontend.auth.login')}}"
        ...
        <li>
            <v-menu close-on-click close-on-content-click internal-activator offset-y>
                ...
                <v-list>
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('frontend.tour.order.index') }}"
                    ...
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('frontend.tour.tour.index') }}"
                    ...
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('frontend.tour.type.index') }}"
                    ...
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('frontend.tour.customer-type.index') }}"
                    ...
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('frontend.tour.hotel-category.index') }}"
                    ...
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('frontend.tour.room-category.index') }}"
                    ...
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('frontend.tour.country.index') }}"
                    ...
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('frontend.tour.hotel.index') }}"
                    ...
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('frontend.tour.museum.index') }}"
                    ...
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('frontend.tour.meal.index') }}"
                    ...
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('frontend.tour.transport.index') }}"
                    ...
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('frontend.tour.guide.index') }}"
                    ...
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('frontend.tour.attendant.index') }}"
        ...
        <li>
            <v-menu offset-y>
                ...
                <v-list>
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('frontend.agency.tour-list') }}"
                    ...
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('frontend.agency.order.index') }}"
        ...
        <li>
            <v-menu close-on-click close-on-content-click internal-activator offset-y>
                ...
                <v-list>
                    ...
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('admin.dashboard') }}" class="tc-main-menu-dropdown-item">
                    ...
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('frontend.user.team') }}"
                    ...
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('frontend.tour.document.index') }}"
                                class="tc-main-menu-dropdown-item {{ active_class(Active::checkRoute('frontend.tour.document.index')) }}">
                                @lang('labels.frontend.document.management')
                            </a>
                        </v-list-item-title>
                    </v-list-item>
                    <v-list-item class="pa-0">
                        <v-list-item-title>
                            <a href="{{ route('frontend.auth.logout') }}" class="tc-main-menu-dropdown-item">
        ...
        <li>
            <v-btn text dark href="{{route('frontend.contact')}}"
    ...
    <v-btn id="tc-main-menu-burger" text dark class="d-xl-none">

                    ...
                    <v-row>
                        <v-col lg="4" cols="12">
                            <v-text-field name="contact_name" color="#aa282a"
                                ...
                                value="{{ old('contact_name') ?? '' }}" maxlength="191" outlined required>
                            </v-text-field>
                        </v-col>
                        <v-col lg="4" cols="12">
                            <v-text-field name="email" prepend-icon="email" color="#aa282a"
                                label="{{ __('labels.frontend.user.profile.email') }}" value="{{ old('email') ?? '' }}"
                                maxlength="191" outlined required></v-text-field>
                        </v-col>
                        <v-col lg="4" cols="12">
                            <v-text-field name="phone" prepend-icon="phone" color="#aa282a"
                                label="{{ __('labels.frontend.user.profile.phone') }}" value="{{ old('phone') ?? '' }}"
                                maxlength="191" outlined required></v-text-field>
                        </v-col>
                    </v-row>
                    <h3 class="text-grey text-center">

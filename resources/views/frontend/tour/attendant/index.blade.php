                            ...
                            <table class="table">
                                ...
                                @foreach($deleted as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <div class="float-right" role="toolbar" aria-label="@lang('labels.general.toolbar_btn_groups')">
                                                <a href="{{ route('frontend.tour.attendant.restore', $item->id) }}" class="btn btn-outline-success ml-1" data-toggle="tooltip" title="@lang('labels.general.buttons.restore')">
                                                    <i class="fas fa-sync"></i></a>
                                                <form style="display: inline-block;" action="{{ route('frontend.tour.attendant.delete-permanently', $item->id) }}" method="post">
                                                    {!! csrf_field() !!}
                                                    <input type="hidden" name="_method" value="DELETE"/>

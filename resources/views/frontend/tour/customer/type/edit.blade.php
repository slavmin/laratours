...
@section('content')
    <div class="row justify-content-center align-items-center">
        <div class="col col-sm-8 align-self-center">
            ...
            {{ html()->form('PATCH', route('frontend.tour.customer-type.update', $item->id))->class('form-horizontal')->open() }}
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-5">
                            <h5 class="card-title mb-0">
                                @lang('labels.frontend.tours.customer.type.edit')
                            </h5>
                        </div><!--col-->
                    </div><!--row-->
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col">
                            {{ form_cancel(route('frontend.tour.customer-type.index'), __('buttons.general.cancel')) }}
                        </div><!--col-->

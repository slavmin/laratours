...
@section('content')
    <div class="row justify-content-center align-items-center">
        <div class="col col-sm-8 align-self-center">
            ...
            {{ html()->form('POST', route('frontend.tour.hotel-category.store'))->class('form-horizontal')->open() }}
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-5">
                            <h5 class="card-title mb-0">
                                @lang('labels.frontend.tours.hotel.category.create')
                            </h5>
                        </div><!--col-->
                    </div><!--row-->
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col">
                            {{ form_cancel(route('frontend.tour.hotel-category.index'), __('buttons.general.cancel')) }}
                        </div><!--col-->

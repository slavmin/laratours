...
@section('content')
    <div class="row justify-content-center align-items-center">
        <div class="col col-sm-8 align-self-center">
            ...
            {{ html()->form('POST', route('frontend.tour.hotel.store'))->class('form-horizontal')->open() }}
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-5">
                            <h5 class="card-title mb-0">
                                @lang('labels.frontend.tours.hotel.create')
                            </h5>
                        </div><!--col-->
                    </div><!--row-->
                    ...
                    <div class="row mt-4">
                        <div class="col">
                            <div class="form-group row">
                                {{ html()->label(__('labels.frontend.tours.hotel.category.name'))
                                    ->class('col-md-2 form-control-label')
                                    ->for('category_id') }}

                                <div class="col-md-10">
                                    {{ html()->select('category_id')
                                    ->options($hotel_categories)->class('form-control') }}
                                </div><!--col-->
                            </div><!--form-group-->

...
>
  ...
  <v-row justify="center">
    <v-btn 
      ...
      href="{{ route('frontend.tour.room-category.create') }}"
    >
    ...
    <v-col>
      <v-card>
        <v-toolbar
          ...
          dark
          color="#94CED7"
          src="/img/frontend/room-category_tmpl.jpg"
        ></v-toolbar>
        @if (count($items)>0)
        <v-simple-table class="mt-5">
          <template v-slot:default>
            <thead>
              <tr>
                <th class="text-left">
                  @lang('labels.frontend.tours.hotel.room.table.name')
                </th>
                <th class="text-left">
                  @lang('labels.frontend.tours.hotel.room.table.description')
                </th>
                <th class="text-right">

...
<v-row>
    ...
    <v-col md="6" sm="12">
        ...
        <v-text-field name="museum_site" label="{{ __('validation.attributes.frontend.site') }}"
            value="{{ $item->museum_site ?? '' }}" maxlength="191" outlined></v-text-field>
        {{-- Museum email --}}
        <v-text-field name="museum_email" label="{{ __('validation.attributes.frontend.email') }}"
            value="{{ $item->museum_email ?? '' }}" maxlength="191" outlined></v-text-field>
        {{-- Museum phone --}}
        <v-text-field name="museum_phone" label="{{ __('validation.attributes.frontend.phone') }}"
            value="{{ $item->museum_phone ?? '' }}" maxlength="191" outlined></v-text-field>
    </v-col>
</v-row>
<v-row>
    <v-col md="6" sm="12">

                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <v-row>
                        <v-spacer></v-spacer>
                        <{{ $model_alias}}-objectable edit-mode :tour-object="{{ $item }}"
                          :object-attribute="{{ $object_attribute }}"
                          :object-attribute-prices="{{ $object_attribute->priceable }}" token="{{ csrf_token() }}"
                          :customers="{{ json_encode($customer_type_options_arrays) }}"></{{ $model_alias}}-objectable>
                        {{ html()
